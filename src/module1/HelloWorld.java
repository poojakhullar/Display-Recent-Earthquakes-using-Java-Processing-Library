...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 0, 0, 350, 500, provider);
		...
		map2 = new UnfoldingMap(this, 305, 0, 350, 500, provider);
		
		// this line zooms in to my hometown
		map2.zoomAndPanTo(zoomLevel, new Location(30.7f, 76.6f));
		
		//making map 2 interactive
